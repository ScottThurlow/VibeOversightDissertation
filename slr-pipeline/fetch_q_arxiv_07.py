#!/usr/bin/env python3
"""
Fetch arXiv results for Q-arXiv-07 (prompts-as-artifact, technical reproducibility
framing) and create matching Zotero items in collection "Q-arXiv-07".

Query: (abs:"prompt engineering" OR abs:"prompt versioning" OR abs:"prompt management"
...
Pairs with Q-IEX-24 and Q-ACM-08. NO client-side dedup — Zotero's built-in dedup
will be run after import.

Usage:
    mkdir -p ~/slr/arxiv/q-arxiv-07
    cd ~/slr/arxiv/q-arxiv-07
    python3 fetch_q_arxiv_07.py              # dry-run: fetch only, no Zotero writes
    python3 fetch_q_arxiv_07.py --apply      # create Zotero items
...
TARGET_COLLECTION_NAME = "Q-arXiv-07"
